...
using sha512_224_context = basic_ossl_hash_context<sha512_224_meta_info>;

struct sha512_256_meta_info
{
	using ctx_type = SHA512_CTX;
	static inline constexpr std::size_t digest_length{SHA256_DIGEST_LENGTH};
	static inline int init_function(ctx_type* c) noexcept
...
using sha512_256_context = basic_ossl_hash_context<sha512_256_meta_info>;
